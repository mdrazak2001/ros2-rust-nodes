...
def generate_launch_description():
    # Declare launch arguments (defaults provided here can be overridden by the top-level launch file)
    ...
    # Define the publisher node. Parameters are passed as ROS parameters.
    publisher_node = Node(
        package='rust_nodes',
    ...
    return LaunchDescription([
        topic_arg, rate_arg, prefix_arg, suffix_arg, count_start_arg,
        publisher_node
    ])
